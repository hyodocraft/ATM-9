...
ServerEvents.recipes(allthemods => {
    ...
    process('glauconite_sand_silked', '128x #forge:ores/glauconite_sand', 'minecraft:water', ['1536x gtceu:glauconite_sand_dust', '1664x gtceu:stone_dust'], ['128x gtceu:sodium_dust', '1536x gtceu:sodium_dust', '1536x alltheores:aluminum_dust', '1536x alltheores:iron_dust'], [6500, 3300, 3300, 6500], [850, 0, 0, 850], 6)
